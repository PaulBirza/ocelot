...
if ( ! function_exists( 'customtheme_scripts' ) ) :
	function customtheme_scripts() {
		...
		if($hostname_match) {
			wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/jquery-3.4.1.min.js', array(), '3.4.1', array( 'jquery' ) );
		} else {
			wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/jquery-3.4.1.min.js', array(), '3.4.1', array( 'jquery' ) );
		}
		...
		if($hostname_match) {
			wp_enqueue_style( 'slick-slider-styles-theme', get_stylesheet_directory_uri() . '/slick/slick-theme.css"' ); 
		} else {
			wp_enqueue_style( 'slick-slider-styles-theme', get_stylesheet_directory_uri() . '/slick/slick-theme.css"' ); 
		}

		// Add our slick slider script
		if($hostname_match) {
			wp_enqueue_script( 'slick-slide', get_template_directory_uri() . '/slick/slick.js', array(), '1.8.0', array( 'slick-slide' ) );
		} else {
			wp_enqueue_script( 'slick-slide', get_template_directory_uri() . '/slick/slick.js', array(), '1.8.0', array( 'slick-slide' ) );
		}
	}
...
// {
//     wp_enqueue_style('bxstyle', '/wp-content/themes/SCHOOLURL/js/jquerybxslider/jquery.bxslider.css');
//     wp_enqueue_script('bxscript', '/wp-content/themes/SCHOOLURL/js/jquerybxslider/jquery.bxslider.min.js', array('jquery'));
// }
